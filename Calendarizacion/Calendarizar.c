...
Barco *obtener_siguiente_barco_prioridad(SistemaCalendarizacion *sistema, int direccion_actual) {
    ...
    while (actual != NULL) {
        if (actual->barco->priority > mayorPrioridad->barco->priority) {  // Comparar usando la prioridad
...
Barco *obtener_siguiente_barco_sjf(SistemaCalendarizacion *sistema, int direccion_actual) {
    ...
    while (actual != NULL) {
        ...
        if (actual->barco->remaining_time < menorTiempo->barco->remaining_time) {
